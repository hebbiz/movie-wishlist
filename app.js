...
const mykolaArchiveMarkScale = [
  [
    "Це радше застереження, ніж порада.",
    "Архів радить обходити обережно. Дуже обережно.",
    "Микола зафіксував це як приклад складних стосунків із кіно.",
  ],
  [
    "Порада звучить так, ніби її дали після важкого вечора.",
    "Картотека бачить більше сумніву, ніж підтримки.",
    "Микола занотував це з помітним скепсисом.",
  ],
  [
    "Це майже негативна рекомендація. Просто у ввічливій обгортці.",
    "Радять, але ніби попереджають.",
    "Архів не забороняє, але й не підштовхує.",
  ],
  [
    "Схоже на рекомендацію через силу.",
    "Фільм залишив більше питань, ніж бажання радити.",
    "Микола бачить тут обережне «ну хіба якщо дуже треба».",
  ],
  [
    "Фільм радять обережно. Дуже обережно.",
    "Підтримка слабка, але не нульова.",
    "Архів ще не списує фільм, але вже тримає олівець напоготові.",
  ],
  [
    "Ентузіазм помірний, але не нульовий.",
    "Це радше стримана цікавість, ніж справжня порада.",
    "Микола бачить слабку симпатію, але без фанфар.",
  ],
  [
    "Тут радше цікавість, ніж захоплення.",
    "Фільм не провалився в очах порадника, але й не переміг.",
    "Картотека занотувала: дивитись можна, очікування — знизити.",
  ],
  [
    "Архів бачить симпатію, але без фанфар.",
    "Порада стримана, але вже не холодна.",
    "Фільм має свої аргументи, просто говорить не дуже голосно.",
  ],
  [
    "Міцна середина. Нічого ганебного.",
    "Фільм тримається рівно, без драматичного тріумфу.",
    "Архів не захоплений, але й не бурчить.",
  ],
  [
    "Порада тримається впевнено, але без пафосу.",
    "Це вже нормальна підтримка, без архівного екстазу.",
    "Микола погоджується: підстави радити є.",
  ],
  [
    "Не Скорсезе, але фільм працює на глядача.",
    "Картотека ставиться до фільму тепло й спокійно.",
    "Порада виглядає чесною і не випадковою.",
  ],
  [
    "Добре зроблено. Архів не сперечається.",
    "Фільм явно має за що зачепитися.",
    "Микола бачить тут впевнену симпатію.",
  ],
  [
    "Сильна порада. Не випадковий запис.",
    "Фільм радять уже не з ввічливості.",
    "Картотека помітно прихильна.",
  ],
  [
    "Схоже, цей фільм справді зачепив.",
    "Тут уже не просто порада, а впевнене схвалення.",
    "Микола занотував це окремим, майже урочистим рядком.",
  ],
  [
    "Тут уже територія дуже доброго кіно.",
    "Архів майже посміхається. Майже.",
    "Порада звучить переконливо.",
  ],
  [
    "Микола бачить серйозну прихильність.",
    "Фільм явно працює не лише на папері.",
    "Це вже сильний аргумент на користь перегляду.",
  ],
  [
    "Фільм явно залишив слід у памʼяті.",
    "Картотека ставить жирну позначку.",
    "Микола визнає: тут є вага.",
  ],
  [
    "Оцінка майже беззаперечна. Архів це помітив.",
    "Фільм дуже близько до статусу обовʼязкового.",
    "Микола вже тягнеться до парадного чорнила.",
  ],
  [
    "Микола знімає капелюха. Повільно.",
    "Архів занотував це з повагою.",
    "Тут уже майже урочистий випадок.",
  ],
  [
    "Шедевр. Картотека аплодує стоячи.",
    "Микола мовчки ставить фільм на верхню полицю.",
    "Архів визнає: це особливий запис.",
  ],
];
